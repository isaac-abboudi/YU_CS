...
public interface DocumentStore
{
     ...
     * return the hashCode of the previous doc. If InputStream is null, this is a delete, and thus
     * return either the hashCode of the deleted doc or 0 if there is no doc to delete.
